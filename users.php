    ...
    <div class="flex-1 transition-all duration-300 ease-in-out p-2 md:px-0 md:pt-4 mt-16 flex flex-col items-center">
        <div class="w-full px-4 md:px-8">
            ...
            <div class="bg-white rounded-lg shadow p-8 text-center text-gray-500">
                <i class="fas fa-users-cog text-5xl mb-4 text-blue-400"></i>
                <div class="text-xl font-semibold mb-2">This is a placeholder for the User Accounts page.</div>
                <div class="mb-4">You can implement user account management features here.</div>
            </div>
        </div>
    </div>
    <script>
